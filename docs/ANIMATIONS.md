...
When an animation is required use Reanimated and Skia where applicable, do not use the Animated API.

The following has been _borrowed_ from [Callstack - React Native Best Practices](https://github.com/callstackincubator/agent-skills/blob/main/skills/react-native-best-practices/references/js-animations-reanimated.md)

The Callstack skill is the authoritative source, will receive updates and will allow to be more conscious of context.
